...
If FileExists($pluginDir) Then
   ;Not used because we are unsure if the @ProgramFilesDir will always return x86 in this case:
   ;$idvBeginPath = @ProgramFilesDir & "\"
   $idvBeginPath = @HomeDrive & "\Program Files (x86)\"
