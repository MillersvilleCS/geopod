		...
		extends JFrame
{
	...
	private void buildInterfaceComponents ()
	{
		...
		m_topViewPanel.setBorder (BorderFactory.createBevelBorder (BevelBorder.RAISED, Color.WHITE, Color.WHITE,
				Color.GRAY, Color.GRAY));
		m_topViewPanel.setOpaque (false);

		m_topCanvas = createOnScreenCanvas (new Dimension (225, 225));
		OffScreenCanvas3D m_OffScreenTopCanvas = createOffScreenCanvas (new Dimension (255, 255));
		...
		addLayeredComponent (m_topViewPanel, JLayeredPane.PALETTE_LAYER, TOP_VIEW_CANVAS_BOUNDS);
